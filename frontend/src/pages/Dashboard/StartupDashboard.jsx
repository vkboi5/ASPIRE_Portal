...
import { useNavigate ,Link} from 'react-router-dom'; // Import useNavigate for React Router v6
        ...
        return (
          <div className="p-6">
            <Card>
              ...
              <CardHeader>
              <CardTitle>Launch your " Venture View "</CardTitle>
                <CardDescription>Get started with your venture view</CardDescription>
                <Button className="w-1/12 bg relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
